...
<div class="sl-mainpanel">
    ...
    <div class="sl-pagebody">
        ...
        <div class="card pd-20 pd-sm-40">
            <h6 class="card-body-title">Add Services</h6>
            ...
            <form action="services_post.php" method="POST">
                <div class="form-layout">
                    <div class="row mg-b-25">
                        <div class="col-lg-6">
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text" name="service_name" placeholder="Enter Service Name">
                            </div>
                        </div><!-- col-6 -->
                        <div class="col-lg-6">
                            <div class="form-group">
                                <label class="form-control-label">Service Discription: <span class="tx-danger">*</span></label>
                                <input class="form-control" type="text" name="service_discription">
                            </div>
                        </div><!-- col-6 -->

                        <div class="col-lg-12">
                            <div class="form-group mg-b-10-force">
                                <label class="form-control-label">Services Icons: <span class="tx-danger">*</span></label>
                                <input id="service_icon_input" class="form-control" name="service_icon"></input>
                                <br>
                                <?php
                    ...
                    <div class="form-layout-footer">
                        <button class="btn btn-info mg-r-5">Add Service</button>

                    </div><!-- form-layout-footer -->
                </div><!-- form-layout -->
            </form>
            <hr>
            <h6 class="card-body-title">List Services</h6>
            <table class="table">
                <thead>
                    <tr>
                        <th>Service Name</th>
                        <th>Service Discription</th>
                        <th>Services Icons</th>
                        <th>Action</th>
                    </tr>
                </thead>
                <tbody>
                     <?php
                            ...
                            $services_from_db = mysqli_query(connect_to_db(), $services_Select_query);
                            ?>
                    <?php foreach ($services_from_db as $single_service) : ?>
                        <tr>
                            <td><?= $single_service['service_name'] ?></td>
                            <td><?= $single_service['service_discription'] ?></td>
